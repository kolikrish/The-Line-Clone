...
import TheLineCollections from "@/public/assets/images/the-studio/img3.webp";
import Desk from "@/public/assets/images/the-studio/img4.webp";
      ...
      >
        ...
        <div className="mt-[158px] flex flex-col lg:mt-[18.5182vw] lg:flex-row lg:px-[0.46296vw]">
          ...
          <div className="max-lg:px-2 max-lg:pt-20 lg:flex-[0.45]">
            ...
            <p className="mb-16 text-[24px] leading-[1.1] font-[470] tracking-[-0.01em] lg:mb-[3.7037vw] lg:max-w-[37.26852vw] lg:text-[1.6vw] lg:font-normal">
            ...
            <div className="grid grid-rows-[auto_auto] gap-2 text-base leading-[1.1] font-[440] tracking-[-0.01em] lg:grid-cols-2 lg:gap-[0.46296vw] lg:text-[1.3vw]">
